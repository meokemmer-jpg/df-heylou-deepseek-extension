...
Schema-Format: DeepSeek-Function-Declarations (JSON-Schema-Subset).
Pflicht: 5 HeyLou-Capabilities (search_hotels / get_rates / compare_otas / book_direct / optimize_revenue).

DeepSeek-Reference: see vendor docs
...
# === HEYLOU FUNCTION DEFINITIONS (DeepSeek-Format) ===
...
def build_tool_payload() -> dict[str, Any]:
    """Build DeepSeek tools payload from function-definitions.

    DeepSeek accepts tools as: {"function_declarations": [...]}
    """
