...
DEFAULT_DF_ID = "df-heylou-deepseek-extension"
SECRET_ENV_VARS = (
    "DF_HEYLOU_DEEPSEEK_HMAC_SECRET",
...
class AuditLogger:
    ...
    DEFAULT_TARGETS = ["deepseek-function-calls", "deepseek-auth"]
    ...
    def log(
        ...
        event_type: str,
        payload: dict,
        target: str = "deepseek-function-calls",
    ) -> AuditEntry:
